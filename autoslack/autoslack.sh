...
echo "# autogenerated by autoslack" > conf.m4
while read line; do
    # skip comments:
    ...
    [ ! -z $name ] && echo "define(\`$name', \`$val') dnl" >> conf.m4
done < $CFGFILE
...
# done generating SlackBuild

# generate  slack-desc
CMDLINE=`which m4`" slack-desc.as"
$CMDLINE  > slack-desc
echo "generated slack-desc"
